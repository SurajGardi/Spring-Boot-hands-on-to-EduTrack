package com.marvellous.Edutrack_StudentPortal.controller;

import com.marvellous.Edutrack_StudentPortal.Entity.BatchEntry;
import com.marvellous.Edutrack_StudentPortal.service.BatchEntryService;
...
//    }
    ...
    public ResponseEntity<BatchEntry> getBatchEntryById(@PathVariable ObjectId myid)
    {
        ...
        {
            return new ResponseEntity<BatchEntry>(batchEntry.get(), HttpStatus.NOT_FOUND);
        }
    }
